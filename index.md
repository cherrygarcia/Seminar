...
This graph is from a US nationally representative survay of adolescent mental health, the national comorbidity survey adolescent supplement--which is actually the dataset that I used for this dissertation. 
...
<!---
Again, in Aim 1 we examined the pieces that are highlighted in red. 
...
This is usually referred to as blunting because the idea is that after repeated or prolonged activation of the stress response system, this response wears out. 
...
Approach: * Propensity score matching with replacement   * Mahalanobis matching within propensity score calipers, which is a way of providing particularly tight control for this variable. 
...
Cortisol as outcome
Measurement limitations
cortisol is sensitivite to a wide range of factors that are typically held constant in when cortisol is measured under laboratory conditions, but were not able to be held constant in its collection in this case. 
