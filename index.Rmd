...
scale_x_discrete(limits=c("trueTMLE", "trueDRWLS", "trueIPW", "trueIPTSvyW", "trueIPTW", "trueIPSW",  "Naive")) +
    ...
    coord_flip() + geom_hline(yintercept=ate, colour="red")  + ylab("PATE") +xlab("") + ggtitle("Scenario 1")+ theme( title=element_text(size=9))
...
scale_x_discrete(limits=c("trueTMLE", "trueDRWLS", "trueIPW", "trueIPTSvyW", "trueIPTW", "trueIPSW",  "Naive")) +
    stat_summary(fun.y=mean, geom="point", shape=5, size=4) + 
    coord_flip() + geom_hline(yintercept=ate, colour="red")  + ylab("PATE") +xlab("") + ggtitle("Scenario 2")+ theme( title=element_text(size=9))
